...
$arr_variable['curriculum'] = array("title"=>esc_html__( 'Project Areas', 'eduma' ), "icon"=>"fa-cube");
$arr_variable['instructor'] = array("title"=>esc_html__( 'Faculty & Sponsor', 'eduma' ), "icon"=>"fa-user");
